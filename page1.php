        ...
        <div class="textepolice"></div>
            ...
            <form method='POST' action='page1.php'>
                        <div class="contenu_double">
                            <div>
                                <p class="texte" style=>Civilité</p>
                                <select class="preadmission" name="civilite" required>
                                <option value="null">Choix</option>
                                <option value="Homme">Homme</option>
                                <option value="Femme">Femme</oprion>
                                </select>
                            </div>
                            <div>
                        ...
                        <div class="contenu_double">
                            <div>
                                ...
                                <input class=preadmission max="2022-12-15" type='date'  name='datenaissance' required>
                            </div>
                            <div>
                        ...
                        <div class="contenu_double">
                            <div>
                                ...
                                <input class=preadmission type='number'  name='CP' required >
                            </div>
                            <div>
